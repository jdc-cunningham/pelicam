...
class IMU:
  def __init__(self, toggle_scared_face):
    ...
    self.toggle_scared_face = toggle_scared_face
  ...
  def begin_sampling(self):
    ...
    while (self.sample_imu):
      ...
      if Ax > 1.6 or Ay > 1.6 or Az > 1.6:
        self.toggle_scared_face(True)
        sleep(2)
        self.toggle_scared_face(False)

      sleep(0.167) # 0.167 is 60fps
